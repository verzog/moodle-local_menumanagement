...
//</ul>';
$string['setting_customnodesusageadmins'] = "Above value is in json format. Please visit this <a href='/local/menumanagement' target='_blank'>link</a> in order to add, edit, remove, reorder menu items.";
//$string['setting_customnodesusageadmins'] = 'Each line consists of a font awesome icon(optional), link title, a link URL and supported language(s) (optional) - separated by pipe characters. Each custom node needs to be written in a new line.<br />
//For example:<br />
...
//<ul>
//<li><b>Font Awesome Icon (optional):</b> This text will include font awesome icon defination. Mention font awesome icon code in curly braces. Example:{fa-home}</li>
...
//</ul>';
$string['setting_customnodesusageusers'] = "Above value is in json format. Please visit this <a href='/local/menumanagement' target='_blank'>link</a> in order to add, edit, remove, reorder menu items.";
//$string['setting_customnodesusageusers'] = 'Each line consists of a font awesome icon(optional), link title, a link URL, supported language(s) (optional) and supported cohort(s) (optional) - separated by pipe characters. Each custom node needs to be written in a new line.<br />
//For example:<br />
//Moodle.org website|http://www.moodle.org|en,de<br />
