...
if ($hassiteconfig) {
    ...
    if ($ADMIN->fulltree) {
        ...
        $defaultCustomNodes = '{"0":{"id":"8","label":"Home","link":"/my/","adminonly":"0","capability":"","icon":"fa fa-home"},"1":{"id":"9","label":"My Dashboard","link":"/local/profile/","adminonly":"0","capability":"","icon":"fa fa-tachometer"},"2":{"id":"11","label":"Calendar","link":"/calendar/view.php?view=month","adminonly":"0","capability":"","icon":"fa fa-calendar"},"3":{"id":"19","label":"My Certificates","link":"/local/certificates/","adminonly":"0","capability":"","icon":"fa fa-certificate"},"4":{"id":"29","label":"My Users","link":"/admin/search.php","adminonly":"1","capability":"","icon":"fa fa-user-circle-o","child":{"0":{"id":"28","label":"Create a new user","link":"/user/editadvanced.php?id=-1","adminonly":0,"capability":"","icon":"fa fa-user-plus"},"1":{"id":"32","label":"Browse Users","link":"/admin/user.php","adminonly":0,"capability":"","icon":"fa fa-users"},"2":{"id":"30","label":"Bulk upload users","link":"/admin/tool/uploaduser/index.php","adminonly":0,"capability":"","icon":"fa fa-user-plus"},"3":{"id":"31","label":"Bulk user actions","link":"/admin/user/user_bulk.php","adminonly":0,"capability":"","icon":"fa fa-users"}}},"5":{"id":"23","label":"Administration","link":"/","adminonly":"1","capability":"","icon":"fa fa-list-alt","child":{"0":{"id":"25","label":"Admin Dashboard","link":"/local/admindashboard/","adminonly":0,"capability":"","icon":"fa fa-th"},"1":{"id":"17","label":"Analytics","link":"/local/intelliboard/","adminonly":0,"capability":"","icon":"fa fa-bar-chart-o"},"2":{"id":"10","label":"Courses","link":"/course/","adminonly":0,"capability":"","icon":"fa fa-book"},"3":{"id":"33","label":"Learnbook Reports","link":"/local/learnbook/report/","adminonly":0,"capability":"","icon":"fa fa-file-text-o"},"4":{"id":"19","label":"Menu Management","link":"/local/menumanagement/","adminonly":0,"capability":"","icon":"fa fa-list-alt"},"5":{"id":"18","label":"Site Administration","link":"/admin/search.php","adminonly":0,"capability":"","icon":"fa fa-cog"},"6":{"id":"27","label":"Theme","link":"/admin/settings.php?section=themesettingnewlearnbook","adminonly":0,"capability":"","icon":"fa fa-photo"}}},"6":{"id":"21","label":"My Teams","link":"/local/myteam/","adminonly":"0","capability":"","icon":"fa fa-users"}}';
